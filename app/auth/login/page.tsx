...
export default function LoginPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const precheckData = (await precheckResponse.json()) as PrecheckResponse & {
        error?: string;
      };

      if (!precheckResponse.ok) {
        throw new Error(precheckData.error || 'Impossible de vérifier le compte.');
      }

      if (!precheckData.allowed) {
        throw new Error(precheckData.message || 'Connexion refusée.');
      }
